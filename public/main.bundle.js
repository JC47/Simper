...
var BalanceFinalComponent = (function () {
    ...
    BalanceFinalComponent.prototype.descargaPDF = function () {
        var cajaBancos, cuentasPorCobrar, IVAAcreditable, almacenArtTerm, almacenMateriales, terreno, edificios, mueblesEnseres, equipoTrans, pagosAnticipado, gastosAmortizacion, IVAPorEnterar, imptosPorPagar, proveedores, PTUPorPagar, prestamosMenosAnio, prestamosMasAnio, capitalSocial, reservaLegal, utilidadAcum, utilidadEjercicio;
...
var VentaProductosComponent = (function () {
    function VentaProductosComponent(_operacionService, _zonasService, _productoService, _graficasService, _dash) {
        var _this = this;
        this._operacionService = _operacionService;
        this._zonasService = _zonasService;
        this._productoService = _productoService;
